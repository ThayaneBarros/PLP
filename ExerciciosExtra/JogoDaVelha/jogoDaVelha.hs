...
novoJogo dados jogador1 jogador2 = do
                                    ...
                                    putStrLn ("\n" ++ jogador1 ++ " será o \'X\' e " ++ jogador2 ++ " será o \'0\'. Vamos lá!!")
                                    getChar
...
-- função que exibi o tabuleiro do jogo da velha
...
-- essa função recebe uma lista com a configuração do tabuleiro, a vez, um elemento (opção escolhida pelo jogador), 
-- retorna uma nova configuração (nova lista)
